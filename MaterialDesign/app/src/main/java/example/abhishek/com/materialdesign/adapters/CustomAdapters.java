...
public class CustomAdapters extends BaseAdapter {
    ...
    public CustomAdapters(Context c, String[] categories_array, int[] imageResId,String[] bkgs) {
        this.context = c;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.customlistadaptersmall, parent, false);
